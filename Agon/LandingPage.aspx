﻿<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="LandingPage.aspx.cs" Inherits="Agon.Pages.LandingPage" %>
...
<header class="navigation fixed-top">
  <nav class="navbar navbar-expand-lg navbar-dark">
    <a class="navbar-brand font-tertiary h3" href="/LandingPage.aspx"><img src="images/Raddi.png" alt="Myself"></a>
    ...
    <div class="collapse navbar-collapse text-center" id="navigation">
      <ul class="navbar-nav ml-auto">
        ...
        <li class="nav-item">
          <a class="nav-link" href="/Pages/sell_scrap.aspx">Sell Raag</a>
        </li>
        <li class="nav-item">
          <a class="nav-link" href="/Pages/Prending_Request.aspx">Pending Request</a>
        </li>
          <li class="nav-item">
          <a class="nav-link" href="/Pages/Login.aspx">Login</a>
        </li>
          <li class="nav-item">
          <a class="nav-link" href="/Pages/Registration.aspx">Register..!</a>
        </li>
        <li class="nav-item">
  ...
  <div class="container">
    <div class="row">
      <div class="col-lg-11 mx-auto">
        <h1 class="text-white font-tertiary">Welcome to <br> Recycle Yard..</h1>
      </div>
    </div>
  </div>
 <br/><br/><br/><br/>
  ...
  <div class="container">
    <div class="row">
      <div class="col-lg-10 mx-auto text-center">
        <p class="font-secondary paragraph-lg text-dark">Tired of searching Radii wala at your local place or carrying bunch of Radii to the Radii wala,Well you are at the right place,just sell your raag on our web site,our person will come at your Doorstep to collect the raag and pay the convienent amount with a gift..:) </p>
